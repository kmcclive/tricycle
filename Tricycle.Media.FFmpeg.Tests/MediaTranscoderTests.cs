...
public class MediaTranscoderTests
{
    ...
    public void RaisesStatusChangedEvent()
    {
        ...
        status.Time.Should().BeCloseTo(new TimeSpan(0, 1, 2, 47, 610), TimeSpan.FromMilliseconds(1));
        status.Eta.Should().BeCloseTo(new TimeSpan(0, 2, 30, 35, 36), TimeSpan.FromMilliseconds(1));
    }
    ...
    public void ParsesFFmpegStatusWithAdditonalParameters()
    {
        ...
        status.Time.Should().BeCloseTo(new TimeSpan(0, 0, 7, 26, 70), TimeSpan.FromMilliseconds(1));
        status.Eta.Should().BeCloseTo(new TimeSpan(0, 1, 18, 28, 837), TimeSpan.FromMilliseconds(1));
    }
