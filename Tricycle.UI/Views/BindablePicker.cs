...
namespace Tricycle.UI.Views
{
    ...
    public class BindablePicker : Picker
    {
        ...
        public static readonly BindableProperty SelectedValueProperty =
            BindableProperty.Create(nameof(SelectedValue), typeof(object), typeof(BindablePicker),
        ...
        static void OnSelectedItemChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            var index = GetIndex(boundPicker.ItemsSource, newValue);
            boundPicker.ItemSelected?.Invoke(boundPicker, new SelectedItemChangedEventArgs(newValue, index));
        ...
        static int GetIndex(IEnumerable itemsSource, object value)
        {
            int result = -1;
            int index = 0;
