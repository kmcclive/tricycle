...
// Adapted from https://github.com/xamarin/Xamarin.Forms/blob/master/Xamarin.Forms.Core/Xaml/TypeConversionExtensions.cs
	...
	static class TypeConversionExtensions
	{
			...
			IServiceProvider serviceProvider, out Exception exception)
		{
			...
			if (value is string str)
			{
				...
				{
					exception = e as XamlParseException ?? new XamlParseException($"Type converter failed: {e.Message}", e);
					return null;
				}
